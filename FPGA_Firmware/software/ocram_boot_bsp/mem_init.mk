...
# Memory: ram_onchip
MEM_0 := WiPhase_top_level_data_ram_onchip
$(MEM_0)_NAME := ram_onchip
...
$(MEM_0)_HIERARCHICAL_PATH := ram_onchip
$(MEM_0)_WIDTH := 32
...
.PHONY: ram_onchip
ram_onchip: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
