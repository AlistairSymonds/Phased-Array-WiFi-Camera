...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../WiPhase_top_level.sopcinfo
...
# Design Name 
# setting SOPC_NAME is WiPhase_top_level
SOPC_NAME := WiPhase_top_level
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10c30
SOPC_SYSID_FLAG += --sidp=0x10c30
ELF_PATCH_FLAG  += --sidp 0x10c30

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1534339154
SOPC_SYSID_FLAG += --timestamp=1534339154
ELF_PATCH_FLAG  += --timestamp 1534339154
