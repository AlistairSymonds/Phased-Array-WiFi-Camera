...
# ----------------------------------------
# ACDS 17.1 590 win32 2018.08.15.23:19:11
...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/WiPhase_top_level_mm_interconnect_0_rsp_demux_003.sv"                       -work rsp_demux_003                             
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/WiPhase_top_level_mm_interconnect_0_cmd_mux_003.sv"                         -work cmd_mux_003                               
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/WiPhase_top_level_mm_interconnect_0_router_005.sv"                          -work router_005                                
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/WiPhase_top_level_timer.v"                                                  -work timer                                     
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L error_adapter_0 -L timing_adapter_1 -L timing_adapter_0 -L data_format_adapter_0 -L avalon_st_adapter -L rsp_mux_001 -L rsp_mux -L rsp_demux_003 -L rsp_demux -L cmd_mux_003 -L cmd_mux -L cmd_demux_001 -L cmd_demux -L cpu_v2_data_master_limiter -L router_005 -L router_002 -L router_001 -L router -L jtag_uart_avalon_jtag_slave_agent_rsp_fifo -L jtag_uart_avalon_jtag_slave_agent -L cpu_v2_data_master_agent -L jtag_uart_avalon_jtag_slave_translator -L cpu_v2_data_master_translator -L i_tse_mac -L cpu -L rst_controller -L avalon_st_adapter_001 -L irq_mapper -L mm_interconnect_0 -L timer -L sysid -L spi -L sample_pll -L ram_onchip -L jtag_uart -L eth -L cpu_v2 -L Debug_ST_Source_0 -L Debug_ST_Sink_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclone10lp_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclone10lp $TOP_LEVEL_NAME
}
