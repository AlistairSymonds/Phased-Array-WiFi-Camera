...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/WiPhase_top_level_cpu_v2_cpu.v"                                             -work cpu                                        -cdslib ./cds_libs/cpu.cds.lib                                       
